...
if (/عميق2/.test(command)) set = '-af atempo=4/4,asetrate=44500*2/3'
...
handler.help = ['عميق', 'منفوخ', 'عميق2', 'earrape', 'fast', 'fat', 'nightcore', 'reverse', 'robot', 'slow', 'smooth', 'tupai'].map(v => v + ' [vn]')
handler.tags = ['audio']
